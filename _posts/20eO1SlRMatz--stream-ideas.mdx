...
0, Setup LayoutMain metadata coming from _app useState to make it easier to setup descriptions, etc...
0, Setup an expanso posts text replacement 
1, Make tl, t2, t3, t4 with tree -L and the number for the number ones and put them in the dot files
0, alphabetize site posts
0, order site posts by date
0, move metadata into LayoutMain
0, make syncher 
