...
type: post
title: >-
  How To Create an Amazon Web Services AWS Identity and Access Management IAM
  Policy That Lets Users Manage Their Own Credentials and Multi-Factor
  Authentication MFA
slug: >-
  20eN8BcnE7W1--how-to-create-an-amazon-web-services-aws-identity-and-access-management-iam-policy-that-lets-users-manage-their-own-credentials-and-multifactor-authentication-mfa
---
