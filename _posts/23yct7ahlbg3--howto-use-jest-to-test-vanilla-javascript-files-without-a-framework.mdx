...
I discovered an issue with this approach. The browser throws the following error:

```bash
Uncaught ReferenceError: module is not defined
```

I'm working to figure out a solution for that. So considering this a work in progress
