...
0, Get redirects working for pages that change title/slugs
0, Finish putting code back in place after moving over to next-mdx-remote
0, Fix images
0, Update the redirects process to accommodate  changes to file names
