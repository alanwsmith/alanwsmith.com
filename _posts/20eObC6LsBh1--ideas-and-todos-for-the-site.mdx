...
0, Pull in the RSS feed for the podcast
0, Convert KSUIDs and redirects to lower case
0, Fix redirects to be all lower case
0, Add redirect where you can just use the ID of the post and have it bounce
0, Setup 'title' in frontmatter as an array so you can do multiple lines
0, Create a 'subtitle' frontmatter key
0, Setup so you can just do the KSUID for the posts and have it redirect to the current title
