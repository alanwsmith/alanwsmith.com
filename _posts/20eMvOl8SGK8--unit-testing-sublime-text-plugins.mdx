---
blurb: >-
  A way to test your Sublime Text Plugins as object. I hope that posting this
  will save others from the 20+ hours of research I put in to figuring out what
  amounts to a few dozen lines of code.
categories:
  - Miscellaneous
...
slug: /posts/20emvol8sgk8--unit-testing-sublime-text-plugins
---
