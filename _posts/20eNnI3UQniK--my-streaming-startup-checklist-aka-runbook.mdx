...
slug: /posts/20enni3uqnik--my-streaming-startup-checklist-aka-runbook
---
...
Move Desktop Audio in OBS to -7.4db (TODO: Check VOD to see how this sounds)
...
SKIP - looking at moving to mac - Open your stream page
...
Break out OBS audio meters so you can see them
`} />


### Live Captions 

Currently not running since the accuracy is so low
...
SKIP - testing looking at stream on mac for now - Mute Twitch on Windows Machine (otherwise it echos)
