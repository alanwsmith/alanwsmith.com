...
ffmpeg -i infile.mkv -filter_complex [0:v:0]split=2[left][right];[left]crop=2048:2048:0:0,<filters for left half here>[left];[right]crop=2048:2048:2048:0,<filters for right half here>[right];[left][right]hstack=2[out] -map [out] …
