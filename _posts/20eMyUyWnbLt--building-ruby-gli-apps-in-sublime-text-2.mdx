---
blurb: >-
  No more jumping to the terminal to launch Ruby GLI Apps. Setup Sublime Text 2
  so you can do it with the Command+B hotkey.
categories:
  - Ruby
  - Programming
...
slug: /posts/20emyuywnblt--building-ruby-gli-apps-in-sublime-text-2
---
