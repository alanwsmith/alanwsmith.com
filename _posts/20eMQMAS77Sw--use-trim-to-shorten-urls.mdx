...
slug: /posts/20emqmas77sw--use-trim-to-shorten-urls
---

TODO: Update this with the fact that tr.im changed the link. This post was in 2009 and the link now goes to a video that was posted in 2014. So, they failed at the primary thing they provide. Plus they put ads inbetween which, I mean, you have to make money some how, but that's the problem with ceeding control



---

There are a few tools out there that let you take a long URL and turn it into a short one. One that I've used in the past is [tinyurl.com](http://tinyurl.com/), but I've recently found another service at [http://tr.im/](http://tr.im/). 

For a shortening service, that's about as short a name as you can get. 

Bonus for the fact that it makes sense and applies to what they do. 

To use tr.im, all you have to do is copy a long URL from the address bar, paste it into the box on their [home page](http://tr.im/) and hit the "tr.im!" button. They'll take your long URL like:

[Update: Nov. 2021 - I must have deleted the original URL at some point cause it's no here and the trim URL doesn't bounce anywhere that makes sense.]

and turn it into something like this: [http://tr.im/71mv](http://tr.im/71mv). 

The trimmed URL is much easier to deal with in email messages and status updates.
