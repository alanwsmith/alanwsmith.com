...
slug: /posts/23wb2q8xhusl--trigger-a-fargate-task-from-aws-lambda
---
...
def lambda_handler(event, context):
    print("Firing off the Fargate headshot engine v2 process")
    client = boto3.client('ecs', region_name='us-east-1')
    response = client.run_task(
        taskDefinition='headshot-test-3:2',
        launchType='FARGATE',
        cluster='headshot-engine-v2-processor-sandbox',
