...
export const getStaticProps = async ({ params }) => {
  // /posts/20eLa1kLssbQ--three-degrees-of-im-seperation

  // NOTE: You have to have this `const post...` even
  // though I'm not sure why
  const post = await getSinglePost(params.slug)

  // const theRedirects = {
  //   200000: '/posts/20eLa1kLssbQ--three-degrees-of-im-seperation',
  //   'a-refined-though-on-great-artists-steal':
  //     '/posts/20eLa1kLssbQ--three-degrees-of-im-seperation',
  // }
  //
  //
  const theRedirects = JSON.parse(
    fs.readFileSync(
      '/Users/alans/workshop/alanwsmith.com/data/legacy_redirects.json'
    )
  )

  if (theRedirects[params.slug]) {
    return {
      redirect: {
