...
export const listData = [
  ...
  [0, 'Pull images from: /__Cleaned/WCAU49878494-1TB-ext/_keep/alans/Backups/StimulatingPixels/blog/wp-content/uploads/2009/01/last-fm-bs.png'],
  [0, 'Make a text only checklist that reads per line so you don't have to make js'],
  [0, 'Add code syntax highlighting'],
  [0, 'Create a files at `/posts` maybe?'],
  [0, 'Default to using filenames for titles with the ability to override via `title` in frontmatter if formatting needs to happen'],
  ...
  [0, 'Update date to show just month and year'],
  ...
  [0, 'Migrate Oh the places I goed to monthly'],
  [0, 'Redo Oh the places I goed pages to one per month'],
