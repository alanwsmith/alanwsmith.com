---
blurb: Don't know specifics of how to do it yet, but the external credential
  process should work
categories:
  - JavaScript
...
type: post
slug: loading-aws-javascript-sdk-v3-credentials-from-a-json-file--20eofjtcl7rl
---
