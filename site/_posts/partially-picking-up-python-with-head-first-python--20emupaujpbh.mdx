---
blurb: Quick review of Head First Python. Not bad, but there's a lot of
  non-python content that gets in the way.
categories:
  - Reviews
...
type: post
slug: partially-picking-up-python-with-head-first-python--20emupaujpbh
---
