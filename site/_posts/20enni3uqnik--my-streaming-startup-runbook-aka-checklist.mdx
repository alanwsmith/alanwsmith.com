...
slug: /posts/20enni3uqnik--my-streaming-startup-runbook-aka-checklist
---
...
Restart facecam
Start SnapCam
Hit Command-6 (which windows sees as ALT-6) to verify snap cam is picking up signals
Start Virtual Cable
Start Audition
...
Set 4K60 Pro MK.2 Resolution to &quot;Scaled - Looks Like 1920x1080&quot;
Set 4K60 Pro MK.2 Refresh Rate to 30 Hertz
Set Sublime Text font size to 30
Set nvAlt Font size to 30
Set Code Runner Font size to 30
Set PyCharm font to 30px
...
<Checklist data={`
Update !today bot command via: _today.txt
...
Prep Link for Pachyderm: https://hachyderm.io/web/home
Open Discord so you can post links
