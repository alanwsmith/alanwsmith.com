...
scrubbed_2021: false
status: published
title: Adding Styles to Hugos YouTube Shortcode Getting Frustrated with Djangos
  Tutorial and Building a Screenshot Renamer
type: post
slug: adding-styles-to-hugos-youtube-shortcode-getting-frustrated-with-djangos-tutorial-and-building-a-screenshot-renamer--20enjh6rorsb
---
