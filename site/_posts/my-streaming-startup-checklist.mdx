...
export const data = [
    ...
    }, 
    {
      ...
      "items": [
        "Pop out chat and followers",
        "Open Twitch In Mod View",
        "Verify snapcam bot is running - D:/Twitch_Stuff/snap_cam_channel_points/02", 
        "Verify snapcam close down bot script is running", 
        "Verify captions are running - D:/Twitch_Stuff/obs_live_captions",
        "TODO: put in all the steps for getting captions running",
    ...
    },
    {
      ...
      "items": [
        "Update Stream Title",
        "Set tags to some of: Programming, IRL, Creative, Web Development, JavaScript, Python",
        ...
        "Start your music",
        "Pop out chat in chrome",
        "Open safari, iterm, and nvAlt in their own desktops"
      ]
    },
    {
      "title": "Misc 2",
      "items": [
        ...
        "Open stream on twitch in windows",
        "Mute stream audio",
        "Start your music"
      ] 
    },
