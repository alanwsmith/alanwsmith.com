...
scrubbed_2021: false
status: published
title: Updating YouTubes Autoplay To Play Consistently With Mute If Necessary
  Hugo Shortcode and Plain JavaScript
type: post
slug: updating-youtubes-autoplay-to-play-consistently-with-mute-if-necessary-hugo-shortcode-and-plain-javascript--20ennizwbyvg
---
