...
date: '2020-10-12'
slug: /explicit-over-implicit-more-code-is-better
tags:
- Python
title: 'Explicit Over Implicit: More Code Is Better'
type: post
---
...
During my search I found [this post titled Coding Best Practices](https://www.topcoder.com/coding-best-practices/). 
...
[^1]: I've realized that I can go to the wonderful [exercism.io](https://exercism.io) for examples of examples. 
...
[^3]: Don't just take my word for it. [The Zen of Python's](https://www.python.org/dev/peps/pep-0020/) second line is literally:
